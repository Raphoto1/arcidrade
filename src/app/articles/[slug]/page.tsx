...
import BackToArticlesButton from "@/components/articles/BackToArticlesButton";
import {
...
export async function generateStaticParams() {
  ...
  const articles = await getPublicArticlesService();
...
export async function generateMetadata({ params }: ArticleDetailPageProps): Promise<Metadata> {
  ...
  const article = await getPublicArticleBySlugService(slug);
