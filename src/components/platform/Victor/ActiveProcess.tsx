        ...
        <div className='flex justify-center flex-col md:flex-row'>
          <div className='flex justify-between w-3/4 flex-col md:flex-row'>
            ...
            <div className="flex flex-col">
              <div className='controles flex flex-col justify-end'>
                <div className="flex justify-end">
                  <h2 className="text-(--soft-Arci)">Plazo:</h2>
                  <p>120 dias</p>
                </div>
                <div className="flex flex-col md:flex-row justify-end">
                  <button className='btn bg-[var(--main-arci)] text-white text-sm h-auto'>Detalle</button>
                  <button className='btn bg-[var(--main-arci)] text-white text-sm h-auto'>Extender Plazo</button>
                  <button className='btn bg-[var(--orange-arci)] text-sm h-auto'>Eliminar</button>
