...
export default function ProfesionalPill() {
  return (
    <div className='w-full h-auto bg-white rounded-md flex flex-col'>
      <div className='w-full h-auto flex'>
        <div className='flex flex-col align-middle justify-center w-2/3 p-1'>
          <h3 className='text-(--main-arci) text-bold text-nowrap font-bold'>Nombre Profesional</h3>
          <div className='flex'>
            <p className='text-sm text-gray-600 w-100'>Cantidad de Procesos:</p>
            <p className='font-light text-[var(--main-arci)]'>8</p>
          </div>
          <div className='flex'>
            <p className='text-sm text-gray-600 w-100'>Especialidad</p>
            <p className='font-light text-[var(--main-arci)]'>Oncologia</p>
          </div>
          <div className='flex'>
            <p className='text-sm text-gray-600 w-100'>Status:</p>
            <p className='font-light text-[var(--main-arci)]'>Graduado</p>
          </div>
          <div className='flex'>
            <p className='text-sm text-gray-600 w-100'>Solicitudes de Aplicación:</p>
            <p className='font-light text-[var(--main-arci)]'>3</p>
          </div>
          <div className='flex'>
            <p className='text-sm text-gray-600 w-100'>Inscrito desde:</p>
            <p className='font-light text-[var(--main-arci)]'>12/12/2025</p>
          </div>
           <div className='flex'>
          ...
          <div className='flex'>
            ...
            <p className='font-light text-[var(--main-arci)]'>Cali</p>
          </div>
        </div>
        <div className='w-1/3 p-1 flex flex-col justify-center'>
          ...
          <button className='btn bg-[var(--main-arci)] w-full text-white h-auto '>Revisar Solicitudes</button>
          <button className='btn bg-[var(--main-arci)] w-full text-white h-auto '>Revisar Procesos</button>
        </div>
      </div>
    </div>
  );
