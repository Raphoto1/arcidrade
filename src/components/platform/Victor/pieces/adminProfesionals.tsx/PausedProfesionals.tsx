...
export default function PausedProfesionals() {
  ...
  // Usar status 'desactivated' para obtener profesionales pausados
  const { data, error, isLoading } = usePaginatedProfesionals(currentPage, itemsPerPage, undefined, undefined, undefined, "desactivated");
    ...
    <div className='w-full justify-center bg-gray-200 px-2'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <select
                  ...
                  <option value=''>Todas las categorías ({data?.data?.length || 0})</option>
              ...
              <div>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span className='text-sm text-gray-500'>{filteredProfesionals.length} resultado(s)</span>
                </div>
              </div>
            </div>
      ...
      {error && (
        <div className='alert alert-error max-w-md mx-auto mb-4'>
          <p>Error al cargar los profesionales pausados</p>
        </div>
      )}
          ...
          {filteredProfesionals.length > 0 ? (
            <div className='grid grid-cols-1 gap-4'>
              {filteredProfesionals.map((profesional: any, index: number) => (
                <ProfesionalPill key={profesional.referCode || `profesional-${index}`} profesional={profesional} isPaused={true} />
              ))}
            </div>
          ) : (
              ...
              <div className='flex flex-col items-center gap-4'>
                {searchTerm || selectedSubArea ? (
                  <>
                    ...
                    <p className='text-gray-500 text-xl'>No se encontraron profesionales pausados</p>
                  ...
                  <>
                    ...
                    <p className='text-gray-500 text-xl'>No hay profesionales pausados</p>
                    <p className='text-gray-400 text-sm'>Los profesionales pausados aparecerán aquí</p>
                  </>
                )}
              </div>
            </div>
