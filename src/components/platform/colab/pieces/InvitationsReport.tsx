...
export default function InvitationsReport() {
  ...
  return (
    <div className='bg-gray-200 p-4 rounded-sm z-10 w-full h-100 flex flex-col'>
      <h1 className='text-lg md:text-xl font-bold font-var(--font-oswald) mb-4 text-center shrink-0'>
        Gestión de Campañas
      </h1>
      ...
      <div className='flex-1 overflow-y-auto space-y-4 pr-2 min-h-0' style={{
        ...
        <div>
          ...
          >
            <div className='flex items-center gap-2'>
              <h2 className='text-md font-bold text-(--main-arci)'>Invitaciones</h2>
              <span className='badge badge-sm bg-(--main-arci) text-white'>
        ...
        <div>
          ...
          >
            <div className='flex items-center gap-2'>
              <h2 className='text-md font-bold text-(--main-arci)'>Leads</h2>
