...
import WebAdminArticlesPanel from "../Victor/webAdmin/WebAdminArticlesPanel";
  ...
  return (
    <div className='FastActions w-full px-4 py-6'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4 justify-center justify-items-center align-middle items-center'>
          ...
          <div className='w-full sm:w-auto'>
            <ModalForPreview title='Administrar Novedades'>
