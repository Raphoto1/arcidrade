...
import UserDescriptionFormGeneral from "@/components/forms/platform/profesional-general/UserDescriptionForm";
import ModalForFormsPlusButton from "@/components/modals/ModalForFormsPlusButton";
import AvatarFormGeneral from "@/components/forms/platform/profesional-general/AvatarForm";
...
export default function HeroHeaderGeneral() {
  ...
  return (
    <div className='relative w-full md:h-85 overflow-hidden'>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://images.pexels.com/photos/3974756/pexels-photo-3974756.jpeg?auto=compress&cs=tinysrgb&w=1920')",
        }}
      />
      ...
      {/* Contenido principal */}
      <div className='HeroArea relative z-10 flex w-full flex-col items-center justify-center gap-3 p-2 md:flex-row md:pr-5'>
        ...
        <div className='description z-10 w-full rounded-sm bg-gray-200 p-4 md:w-1/3'>
      ...
      {/* Opciones */}
      <div className='options relative z-10 grid justify-center md:pr-5'>
        <h3 className='text-xl text-center capitalize'>{Array.isArray(data?.payload) && data.payload[1]?.title || "Título Principal"}</h3>
        ...
        <div className='flex justify-center'>
          <div className='flex flex-wrap justify-center gap-2'>
            <ModalForPreview title={"Preview"}>
              <ProfesionalDetail hideEspecialidad={true} />
            </ModalForPreview>
            <ModalForPreview title={"Preview Full"}>
              <ProfesionalDetailFull hideEspecialidad={true} />
            </ModalForPreview>
          </div>
        </div>
      </div>
