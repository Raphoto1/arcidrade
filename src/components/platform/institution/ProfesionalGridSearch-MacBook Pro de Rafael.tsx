        ...
        {showFilters && (
          <div className='bg-white mx-4 mb-4 p-4 rounded-lg border border-gray-300 shadow-sm'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700 mb-1'>Especialización Médica</label>
                <select
            ...
            <div className='flex flex-wrap justify-center gap-2'>
              ...
              {selectedCountry && (
                <span className='inline-flex items-center gap-1 bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs'>
                  ...
                  <button onClick={() => setSelectedCountry("")} className='text-yellow-600 hover:text-yellow-800'>
                    <FiX size={12} />
                  </button>
                </span>
              )}
              {selectedSpecialization && (
                <span className='inline-flex items-center gap-1 bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs'>
                  ...
                  <button onClick={() => setSelectedSpecialization("")} className='text-green-600 hover:text-green-800'>
                    <FiX size={12} />
                  </button>
                </span>
              )}
            ...
            {paginatedData?.data?.length > 0
              ...
              : !isLoading && (
                  <div className='col-span-full text-center text-gray-500 py-8'>
                    {hasActiveFilters ? "No se encontraron instituciones que coincidan con los filtros aplicados" : "No hay instituciones disponibles"}
                  </div>
                )}
          </div>
        </div>
