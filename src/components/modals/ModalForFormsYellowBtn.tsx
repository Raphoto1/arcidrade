...
export default function ModalForFormsYellowBtn({ children, title }: ModalProps) {
  ...
  return (
    <div>
      {title && (
        <button className='btn bg-warning h-auto p-1 w-full text-white' onClick={openModal}>
          {title}
        </button>
      )}
