...
export default function ConfirmDeleteUserInvitationForm(props: any) {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      // Actualizar la lista de invitaciones si se proporciona el mutate
      if (props.onMutate) {
    ...
    <div className='flex flex-col justify-center align-middle items-center max-w-md mx-auto p-4'>
      ...
      <div className='text-center mb-6'>
        <p className='text-lg text-gray-700 mb-3'>
          ¿Está seguro que desea eliminar permanentemente esta invitación?
        </p>
        ...
        <div className='bg-yellow-50 border border-yellow-300 rounded-lg p-4 mb-4'>
          ...
          <p className='text-xs text-yellow-700'>
            Se eliminarán todos los datos asociados al usuario ó la invitación:
          </p>
