  ...
  return (
    <div className='flex flex-col justify-center align-middle items-center max-w-md mx-auto p-4'>
      <h1 className='text-2xl fontArci text-center pb-5 text-[var(--main-arci)]'>
        Convertir a Proceso Arcidrade
      </h1>
      
      <div className='text-center mb-6'>
        <p className='text-lg text-gray-700 mb-3'>
          ¿Desea convertir este proceso en Arcidrade?
        </p>
        ...
        <p className='text-sm text-gray-600'>
          Al convertirlo en proceso Arcidrade, será marcado con la certificación oficial de nuestra plataforma.
        </p>
      </div>
