...
export default function ConfirmActivateUserForm(props: any) {
  ...
  const handleActivateUser = async () => {
    ...
    try {
      const response = await fetch("/api/platform/victor/adminUser/activate/", {
        method: "PUT",
        body: JSON.stringify({ 
          ...
          <div className='flex'>
            ...
            <div className='ml-3'>
              <p className='text-sm text-yellow-700'>
                Al Activar el usuario, este podrá usar la plataforma hasta que sea pausado.
              </p>
            </div>
          </div>
        </div>
