...
export const getAllInstitutionsPaginatedService = async (page: number = 1, limit: number = 9, search?: string, country?: string, specialization?: string, status?: StatusAvailable) => {
